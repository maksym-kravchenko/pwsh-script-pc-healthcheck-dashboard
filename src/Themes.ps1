# =============================================================================
#  THEMES
#  Color palettes plus the brush cache and Apply-Theme. To add a theme, copy one
#  of the blocks below and extend the toggle in $btnTheme.Add_Click (Dashboard.ps1).
# =============================================================================
...
function ConvertTo-Brush {
    ...
    # Freezing makes the brush immutable, so WPF skips change tracking on assignment
    # and we can safely reuse one cached instance everywhere on the UI thread.
    $brush.Freeze()
